...
const chartOptions = computed(() => {
    return {
        ...
        colors: [BLUE_THEME.colors.primary, BLUE_THEME.colors.primary, BLUE_THEME.colors.secondary, BLUE_THEME.colors.primary, BLUE_THEME.colors.primary, BLUE_THEME.colors.primary],
        plotOptions: {
            bar: {
                borderRadius: 4,
                columnWidth: '45%',
