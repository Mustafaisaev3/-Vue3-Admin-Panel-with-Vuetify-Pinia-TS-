...
import type { blogType, blogpostType } from '@/types/apps/blog';
...
const BlogPosts: blogpostType[] = [
    ...
    {
        id: 9,
        title: 'Early Black Amazon deals: cheap TVs, headphones',
        content: chance.paragraph({ sentences: 2 }),
        coverImg: s9,
...
const getPostById = (id: any) => {
    const targetPost = BlogPosts.filter((post: any) => {
        return parseInt(id) === post.id 
    })
    return targetPost[0]
}

export { BlogPosts, getPostById }